...
#define NL_CLOUD4_THRESHOLD 0.40         // 0.0 more clouds ~ 1.0 less clouds
#define NL_CLOUD4_SOFTNESS 1.1           // 0.05 sharp edges ~ 1.0 soft edges
#define NL_CLOUD4_DENSITY 1.1            // 0.1 thin ~ 3.0 thick
#define NL_CLOUD4_LAYER_GAP 0.035        // 0.001 tight layers ~ 0.05 spread layers
#define NL_CLOUD4_SHADOW_STRENGTH 0.15   // 0.0 flat ~ 1.0 strong inner shadow
