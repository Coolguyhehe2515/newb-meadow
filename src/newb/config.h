...
/* Cloud type */
#define NL_CLOUD_TYPE 1 // 0:vanilla, 1:soft, 2:rounded, 3:realistic, 4:layered
...
#define NL_CLOUD4_SCALE 7.0              // 1.0 large ~ 20.0 tiny
#define NL_CLOUD4_SPEED 0.06             // 0.0 static ~ 1.0 fast moving
#define NL_CLOUD4_THRESHOLD 0.50         // 0.0 more clouds ~ 1.0 less clouds
#define NL_CLOUD4_SOFTNESS 0.8           // 0.05 sharp edges ~ 1.0 soft edges
#define NL_CLOUD4_DENSITY 1.1            // 0.1 thin ~ 3.0 thick
...
#define NL_CLOUD4_SUN_COLOR vec3(1.0, 0.97, 0.90)
#define NL_CLOUD4_SHADE_COLOR vec3(0.58, 0.64, 0.76)
...
#define NL_GALAXY_HORIZON_HEIGHT 0.05   // 0.0 low ~ 0.5 high
#define NL_GALAXY_HORIZON_FADE 0.45     // 0.05 sharp cutoff ~ 1.0 gradual fade
