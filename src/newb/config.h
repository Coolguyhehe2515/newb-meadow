...
/* Color correction */
#define NL_TONEMAP_TYPE 5              // 1:Exponential, 2:Reinhard, 3:Extended Reinhard, 4:ACES, 5:Uncharted2/Hable
...
#define NL_NETHER_AMBIENT vec3(0.32,0.22,0.19)
#define NL_END_AMBIENT    vec3(1.6,1.6,1.6)

/* Sun/moon light color */
#define NL_DAWN_SUNLIGHT_COL   vec3(1.0,0.4,0.1)
#define NL_NOON_SUNLIGHT_COL   vec3(1.0,0.75,0.57)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.005,0.015,0.1)
...
#define NL_END_HORIZON_COL   vec3(0.12,0.12,0.12)
...
#define NL_CLOUD4_DENSITY 2.0            // 0.1 thin ~ 3.0 thick
#define NL_CLOUD4_LAYER_GAP 0.010        // 0.001 tight layers ~ 0.05 spread layers
#define NL_CLOUD4_SHADOW_STRENGTH 0.3    // 0.0 flat ~ 1.0 strong inner shadow
#define NL_CLOUD4_SUN_COLOR vec3(1.0, 0.98, 0.94)
#define NL_CLOUD4_SHADE_COLOR vec3(0.78, 0.81, 0.87)
#define NL_CLOUD4_AMBIENT_COLOR vec3(0.93, 0.95, 0.98)
...
#define NL_GALAXY_HORIZON_HEIGHT -0.05  // -0.3 low ~ 0.3 high
#define NL_GALAXY_HORIZON_FADE 0.65     // 0.05 sharp cutoff ~ 1.0 gradual fade
...
#define NL_ENTITY_LIGHT_TINT           // [toggle] desaturate entities away from light, warm tint near light
#define NL_ENTITY_DESAT_DARK     0.35 // 0.0 fully grayscale in dark ~ 1.0 no desaturation
#define NL_ENTITY_TINT_DARK  vec3(0.9,0.95,1.05)
#define NL_ENTITY_TINT_LIT   vec3(1.1,1.0,0.85)
...
*/
  ...
  #undef NL_GODRAY
  #undef NL_UNDERWATER_GODRAY
#endif

#ifdef NL_CLOUD_TIER_LOW
  #undef NL_GALAXY_STARS
  #undef NL_GROUND_REFL
  #undef NL_GODRAY
  #define NL_GODRAY 0.3
  #undef NL_UNDERWATER_GODRAY
  #define NL_UNDERWATER_GODRAY 0.3
  #undef NL_CLOUD3_SPEED
  #define NL_CLOUD3_SPEED 0.0
#endif

#ifdef NL_CLOUD_TIER_MEDIUM
  #undef NL_GALAXY_STARS
  #undef NL_CLOUD3_SPEED
  #define NL_CLOUD3_SPEED 0.0
#endif
